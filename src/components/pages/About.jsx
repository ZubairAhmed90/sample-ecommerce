    ...
    >
      <Box className="w-100 w-sm-100 w-md-50">
        <Typography className="fs-1 fw-bold mb-2" variant="h3">
          {" "}
          All-in-One General Store: Gokuldham Society
        </Typography>
        <Typography
          className="fw-light"
          component="p"
        ...
        >
          {" "}
          Our team is a combination of supportive job coaches and dream seeking associates.
           Together, we create a fun, educational, and enriching environment as we work to provide
